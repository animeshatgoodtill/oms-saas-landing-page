...
export default function AssetLifecyclePage() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            const sections = assetLifecycleGuide.sections;
        ...
        <main>
            <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-16">
                <Container>
                    ...
                    <h1 className="text-4xl md:text-5xl font-heading font-bold mb-4">
                        {assetLifecycleGuide.title}
                    </h1>
                    <p className="text-xl text-blue-100 max-w-3xl">
                        {assetLifecycleGuide.description}
                    </p>
                    <p className="text-sm text-blue-200 mt-4">
                        Last updated: {assetLifecycleGuide.lastUpdated}
                    </p>
                </Container>
            </section>
            ...
            <Container className="py-12">
                <div className="flex flex-col lg:flex-row gap-8">
                    <DocSidebar sections={assetLifecycleGuide.sections} activeSection={activeSection} />
                    <div className="flex-1 max-w-4xl">
                        {assetLifecycleGuide.sections.map((section) => (
