...
export default function FieldServiceDocsPage() {
    const [activeSection, setActiveSection] = useState<string>('');

    useEffect(() => {
        const handleScroll = () => {
            const sections = fieldServiceGuide.sections;
        ...
        <Container>
            <div className="py-16 md:py-24">
                <div className="max-w-7xl mx-auto flex gap-8">
                    {/* Sidebar */}
                    <DocSidebar sections={fieldServiceGuide.sections} activeSection={activeSection} />

                    {/* Main Content */}
                    <div className="flex-1 max-w-3xl">
                        {/* Header */}
                        <div className="mb-8">
                            <h1 className="text-4xl md:text-5xl font-bold mb-4">{fieldServiceGuide.title}</h1>
                            <p className="text-xl text-gray-600 mb-2">{fieldServiceGuide.description}</p>
                            <p className="text-sm text-gray-500">Last updated: {fieldServiceGuide.lastUpdated}</p>
                        </div>

                        {/* Sections */}
                        <div className="space-y-8">
                            {fieldServiceGuide.sections.map((section, index) => (
                        ...
                        <div className="mt-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                If you&apos;re having trouble with the field service app or need assistance with any features,
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                >
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Learn how jobs are created, scheduled, and managed
                                    </p>
                                </Link>
                                <Link
                                ...
                                >
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Creating and issuing compliance certificates
                                    </p>
                                </Link>
                                <Link
                                    ...
                                    className="block p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition"
                                >
                                    <h4 className="font-bold text-blue-600 mb-2">Defects to Quotation</h4>
                                    <p className="text-sm text-gray-600">
                                        Converting field defects into remedial quotes
                                    </p>
                                </Link>
                                <Link
                                ...
                                >
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Capturing and managing site assets from the field
                                    </p>
                                </Link>
                            </div>
                        </div>
