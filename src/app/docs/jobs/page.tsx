...
export default function JobsDocsPage() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            const sections = jobsGuide.sections;
        ...
        <Container>
            <div className="py-16 md:py-24">
                <div className="max-w-7xl mx-auto flex gap-8">
                    {/* Sidebar */}
                    <DocSidebar sections={jobsGuide.sections} activeSection={activeSection} />

                    {/* Main Content */}
                    <div className="flex-1 max-w-3xl">
                        {/* Header */}
                        <div className="mb-8">
                            <h1 className="text-4xl md:text-5xl font-bold mb-4">{jobsGuide.title}</h1>
                            <p className="text-xl text-gray-600 mb-2">{jobsGuide.description}</p>
                            <p className="text-sm text-gray-500">Last updated: {jobsGuide.lastUpdated}</p>
                        </div>

                        {/* Sections */}
                        <div className="space-y-8">
                            {jobsGuide.sections.map((section, index) => (
                        ...
                        <div className="mt-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                If you&apos;re having trouble with jobs or need assistance with scheduling and workflow,
