...
export default function OfflineSyncPage() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            const sections = offlineSyncGuide.sections;
        ...
        <main>
            <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-16">
                <Container>
                    ...
                    <h1 className="text-4xl md:text-5xl font-heading font-bold mb-4">
                        {offlineSyncGuide.title}
                    </h1>
                    <p className="text-xl text-blue-100 max-w-3xl">
                        {offlineSyncGuide.description}
                    </p>
                    <p className="text-sm text-blue-200 mt-4">
                        Last updated: {offlineSyncGuide.lastUpdated}
                    </p>
                </Container>
            </section>
            ...
            <Container className="py-12">
                <div className="flex flex-col lg:flex-row gap-8">
                    <DocSidebar sections={offlineSyncGuide.sections} activeSection={activeSection} />
                    <div className="flex-1 max-w-4xl">
                        {offlineSyncGuide.sections.map((section) => (
