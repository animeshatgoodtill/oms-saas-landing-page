...
const RemedialScopeOfWorksDocPage = () => {
  const [activeSection, setActiveSection] = useState('overview');

  useEffect(() => {
    const handleScroll = () => {
      const sections = remedialScopeOfWorksGuide.sections;
    ...
    <div className="min-h-screen bg-white">
        ...
        <Container>
          <div className="max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
              ...
              <span>/</span>
              <span className="text-foreground">Remedial Scope of Works</span>
            </div>

            <h1 className="font-heading text-4xl md:text-5xl font-bold text-foreground mb-4">
              {remedialScopeOfWorksGuide.title}
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed mb-4">
              {remedialScopeOfWorksGuide.description}
            </p>
            <p className="text-sm text-muted-foreground">
              Last updated: {new Date(remedialScopeOfWorksGuide.lastUpdated).toLocaleDateString('en-GB', {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
              })}
      ...
      <Container>
        <div className="flex gap-12 relative">
          {/* Sidebar TOC */}
          <DocSidebar sections={remedialScopeOfWorksGuide.sections} activeSection={activeSection} />

          {/* Content Area */}
          <main className="flex-1 py-12 min-w-0 lg:pl-8">
            <div className="max-w-3xl">
              {remedialScopeOfWorksGuide.sections.map((section) => (
...
export default RemedialScopeOfWorksDocPage;
