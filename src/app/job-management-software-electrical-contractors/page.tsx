          ...
          <section className="mb-16">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg leading-relaxed text-foreground-accent">
                  The software fits teams with five to fifty employees. It works well for small British electrical firms that want to grow. Starter plans help micro-firms with up to three users. Business plans support larger teams with more needs.
                </p>
              </div>
              ...
              <div>
                <h3 className="font-heading font-bold text-xl text-foreground mb-3">What About NICEIC or ECA Registration?</h3>
                <p className="text-lg leading-relaxed text-foreground-accent">
