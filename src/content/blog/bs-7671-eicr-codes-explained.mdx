...
- **Defect logging links directly to remedial quotes** — log a C2, generate a quote from the same screen using our [quotation workflow](/features/quotations)
...
Engineers log defects on-site through the [field service app](/features/field-service), and the office sees them immediately — no waiting for paperwork.
