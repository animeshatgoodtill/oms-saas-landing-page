...
|-----------|--------------|----------------|
| **Starter** | £49 + VAT | 1 User |
| **Team** | £99 + VAT | 3 Users |
| **Business** | £149 + VAT | 5 Users |
...
The software fits teams with five to fifty employees. It works well for small British firms that want to grow. Starter includes one user and suits a sole trader; Team includes three. Business plans support larger teams with more needs.
...
**Ready to transform your electrical business?** [Start your 30-day free trial](https://app.opscel.com/handler/sign-up) or [book a demo](https://calendar.app.google/Tp8Hwzbf6tVMGDkW6) to see Opscel in action.
